...
- **保存ファイル**: 
  - `data/experiments/analysis_2511061957/features/wikiart_vlm_features_Stable-Diffusion.csv` (21MB)
  - `data/experiments/analysis_2511061957/features/wikiart_vlm_features_with_gestalt_Stable-Diffusion.csv` (38MB)
...
- **誤分類分析**:
  ...
  - 偽陰性（フェイクを本物と誤分類）: 61
- **保存ファイル**:
  - `data/experiments/analysis_2511062324/models/random_forest_model.pkl`
  - **`data/experiments/analysis_2511062324/models/scaler.pkl`** ✅（訓練データのみでfit）

### ✅ SHAP説明生成
- **スケーラー使用**: 保存されたスケーラーを使用 ✅
- **SHAP値計算**: 完了（100サンプル）
- **保存ファイル**:
  - `data/experiments/analysis_2511062324/visualizations/shap_summary_plot.png`
  - `data/experiments/analysis_2511062324/visualizations/shap_feature_importance.png`
  - `data/experiments/analysis_2511062324/visualizations/dependence_plot_*.png`
  - `data/experiments/analysis_2511062324/shap_explanations/shap_values.csv`
  - `data/experiments/analysis_2511062324/shap_explanations/feature_importance_shap.csv`
