...
```
data/experiments/analysis_2511052310/features/wikiart_vlm_scaler_with_gestalt_Stable-Diffusion.pkl
data/experiments/analysis_2511052310/features/wikiart_vlm_scaler_Stable-Diffusion.pkl
data/experiments/analysis_2511032213/features/wikiart_vlm_scaler_Stable-Diffusion.pkl
data/experiments/analysis_2511052259/features/wikiart_vlm_scaler_Stable-Diffusion.pkl
data/experiments/analysis_2511050614/features/wikiart_vlm_scaler_Stable-Diffusion.pkl
data/experiments/analysis_2511050822/features/wikiart_vlm_scaler_with_gestalt_Stable-Diffusion.pkl
data/experiments/analysis_2511050822/features/wikiart_vlm_scaler_Stable-Diffusion.pkl
data/experiments/analysis_2511052300/features/wikiart_vlm_scaler_with_gestalt_Stable-Diffusion.pkl
data/experiments/analysis_2511052300/features/wikiart_vlm_scaler_Stable-Diffusion.pkl
data/experiments/analysis_2511031928/features/wikiart_vlm_scaler_with_gestalt_Stable-Diffusion.pkl
data/experiments/analysis_2511031928/features/wikiart_vlm_scaler_Stable-Diffusion.pkl
```
...
# 特徴量ファイルを読み込み
df = pd.read_csv('data/experiments/analysis_XXXXXX/features/wikiart_vlm_features_with_gestalt_Stable-Diffusion.csv')
...
```bash
ls -la data/experiments/analysis_XXXXXX/models/scaler.pkl
```
