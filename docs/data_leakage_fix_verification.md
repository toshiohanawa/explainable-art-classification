...
- **ファイル**: `data/analysis_2511061957/features/wikiart_vlm_features_with_gestalt_Stable-Diffusion.csv`
- **特徴量数**: 68カラム
- **サンプル数**: 17,328件
- **データリーク修正の確認**:
...
- **ファイル**: `data/analysis_2511062324/models/scaler.pkl`
- **サイズ**: 2.0KB
- **型**: `StandardScaler`
- **確認内容**:
...
- **ファイル**: `data/analysis_2511062324/models/random_forest_model.pkl`
- **サイズ**: 18MB
- **モデル性能**:
  - テスト精度: **95.53%** ✅
  - 訓練精度: 100.00%
...
- **ファイル**:
  - `data/analysis_2511062324/shap_explanations/shap_values.csv` (148KB)
  - `data/analysis_2511062324/shap_explanations/feature_importance_shap.csv` (2.7KB)
- **確認内容**:
